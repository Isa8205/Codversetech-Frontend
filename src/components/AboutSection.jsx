      ...
      <div className="flex flex-col lg:flex-row items-center max-w-6xl mx-auto p-8 space-y-6 lg:space-y-0 lg:space-x-8">
        ...
        <div className="flex-1">
          ...
          <p className="text-lg text-[#8892b0] leading-relaxed mt-4">
            Founded in 2024, Codverse Tech is dedicated to <span className="text-[#64ffda]">empowering businesses</span> through innovative technology solutions. 
            ...
            led by experienced professionals like Derrick Moiben, our CEO, and Isaiah Kibet, our Lead Developer, is 
            ...
            our clients to ensure their expectations are not just met, but exceeded. Join us on this journey to <span className="text-[#64ffda]">revolutionize your business with cutting-edge technology</span>.
          </p>
        </div>
        {/* Image */}
        <div className="flex-1">
